//Set Control Room marker
    ...
    if (acemod) then {
		_lhdcontrol = ["lhdcontrol","Logistics Control","",{[] spawn airboss_fnc_ui_debarkationControl},{position player in LHD_Location}] call ace_interact_menu_fnc_createAction;
...
//Create deck location (used to check when landed)
	LHD_Deck = createLocation ["NameLocal", _lhdpos, 32, 125];
	LHD_Deck setRectangular true;
	LHD_Deck setDirection _lhddir;
    ["deckarea", _lhdpos, "RECTANGLE", [32,260], "COLOR:", "ColorBlue", "BRUSH:", "Border"] call CBA_fnc_createMarker;
...
//Set FlyCo Control Area
    ...
    ["flycoarea", _lhdpos, "ELLIPSE", [1000, 1500], "COLOR:", "ColorGreen", "BRUSH:", "Border"] call CBA_fnc_createMarker;
...
//Set Homer Restricted Area
    ...
    ["homerarea", _lhdpos, "ELLIPSE", [2500, 2500], "COLOR:", "ColorRed", "BRUSH:", "Border"] call CBA_fnc_createMarker;
...
//Create the Finals marker
	...
	_marker = createMarker["LHD_finals",_position];
	_marker setMarkerShape "ICON";
	_marker setMarkerType "EMPTY";